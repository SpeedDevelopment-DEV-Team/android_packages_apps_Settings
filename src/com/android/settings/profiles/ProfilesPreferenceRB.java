...
public class ProfilesPreferenceRB extends CheckBoxPreference {
    private static final String TAG = ProfilesPreferenceRB.class.getSimpleName();
    ...
    public ProfilesPreferenceRB(SettingsPreferenceFragment fragment, Bundle settingsBundle) {
        super(fragment.getActivity(), null, R.style.ProfilesPreferenceStyleRadioButton);
        setLayoutResource(R.layout.preference_profiles);
        setWidgetLayoutResource(R.layout.preference_profiles_widget_radiobutton);
        mFragment = fragment;
